...
<body class="contact-v1">
	...
	<div class="page-content">
		...
		<!-- Breadcrumb Section -->
		<section class="breadcrumb-contact-v1 breadcrumb-section section-box" style="background-image: url(images/contact-v1-bc.jpg)">
			<div class="container">
		...
		<section class="map-section">
			<div class="google-map-section">
				<div class="map-wrapper js-google-map" data-makericon="images/icons/contact-icon-map.png" data-makers='[["AUservice", "Now that you visited our website,<br> how about checking out our office too?", 37.416047, -122.076849]]'>
		...
		<!-- Contact Section -->
		<section class="contact-v1-section contact-v3-section">
			<div class="container">
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="contact-content">
							<div class="contact-icon">
								<img src="images/icons/contact-icon-1.png" alt="icon-1">
							</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="contact-content">
							<div class="contact-icon">
								<img src="images/icons/contact-icon-2.png" alt="icon-2">
							</div>
							<div class="contact-info">
								<span class="tel"><a href="tel:1235268679">+1 23 526 8679</a></span>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="contact-content">
							<div class="contact-icon">
								<img src="images/icons/contact-icon-3.png" alt="icon-3">
							</div>
							<div class="contact-info">
								<p class="date">Weekdays: 8:00am - 6:00pm </p>
								<p class="time">Sat - Sun: 9:00am - 5:00pm </p>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="contact-form-section contact-form-section-v1">
			<div class="container">
				<div class="quote-form">
					<h2 class="special-heading">SEND US A MESSAGE</h2>
					<form class="form-contact js-contact-form" method="POST" action="includes/contact-form.php">
						<div class="row">
							...
							<div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 form-textarea">
