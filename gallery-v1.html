...
<body class="gallery-v1">
	...
	<div class="page-content">
		...
		<!-- Breadcrumb Section -->
		<section class="breadcrumb-gallery-v1 breadcrumb-section section-box" style="background-image: url(images/gallery-v1-bc.jpg)">
			<div class="container">
		...
		<section class="gallery-section isotope-section section-box">
			<div class="container">
	            ...
	            <div class="row isotope-grid">
	            	<!-- Product-1 -->
	                <div class="wheel col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-1.jpg" alt="gallery-1">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Unde Omnisiste Natus</p>
								<a href="images/gallery-v1-1.jpg" data-fancybox="gallery" class="gallery-elements">
	                ...
	                <!-- Product-2 -->
	                <div class="engine col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-2.jpg" alt="gallery-2">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Omnisiste Unde Natus</p>
								<a href="images/gallery-v1-2.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <div class="wheel col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
                        <div class="gallery-content">
							<img src="images/gallery-v1-3.jpg" alt="gallery-3">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Omnisiste Unde Natus</p>
								<a href="images/gallery-v1-3.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <!-- Product-4 -->
	                <div class="mechanic col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-4.jpg" alt="gallery-4">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Duis Quis Eros Imperdiet.</p>
								<a href="images/gallery-v1-4.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <div class="wheel col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-5.jpg" alt="gallery-5">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Nostrum Exerci Tatio</p>
								<a href="images/gallery-v1-5.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <div class="engine col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-6.jpg" alt="gallery-6">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Reprehen Voluptate</p>
								<a href="images/gallery-v1-6.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <!-- Product-7 -->
	                <div class="door col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-7.jpg" alt="gallery-7">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Moditempora Incidunt</p>
								<a href="images/gallery-v1-7.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <div class="mechanic col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-8.jpg" alt="gallery-8">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Suscipit Laboriosam</p>
								<a href="images/gallery-v1-8.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <!-- Product-9 -->
	                <div class="body col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-9.jpg" alt="gallery-9">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Inventore Veritatis</p>
								<a href="images/gallery-v1-9.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <div class="door col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-10.jpg" alt="gallery-10">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Voluptate Velitesse</p>
								<a href="images/gallery-v1-10.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <div class="body col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-11.jpg" alt="gallery-11">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Occaecat Cupidatat</p>
								<a href="images/gallery-v1-11.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
	                ...
	                <div class="body col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 isotope-item">
	                	<div class="gallery-content">
							<img src="images/gallery-v1-12.jpg" alt="gallery-12">
							<div class="overlay"></div>
							<div class="gallery-text">
								<p>Deserunt Mollitanim</p>
								<a href="images/gallery-v1-12.jpg" data-fancybox="gallery" class="gallery-elements">
                            		<i class="la la-search-plus"></i>
                                </a>
							</div>
						</div>
