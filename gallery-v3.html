...
<body class="gallery-v3">
	...
	<div class="page-content">
		...
		<!-- Breadcrumb Section -->
		<section class="breadcrumb-gallery-v1 breadcrumb-section section-box" style="background-image: url(images/gallery-v3-bc.jpg)">
			<div class="container">
				<div class="breadcrumb-inner">
					<h1>ALL GALLERY</h1>
					<ul class="breadcrumbs">
						<li><a class="breadcrumbs-1" href="index.html">Home</a></li>
						<li><p class="breadcrumbs-2">Gallery</p></li>
					</ul>
				</div>	
			</div>
		</section>
		...
		<!-- Gallery Section Isotope Section -->
		<section class="gallery-section gallery-v3-section isotope-section section-box">			
			<div class="container">
				<div class="gallery-total">
					<ul class="project-tabs filter-tope-group">
		                <li class="active filter-tope-items">
		                    <span data-filter="*">View All</span>
		                </li>
		                <li class="filter-tope-items">
		                    <span data-filter=".wheel ">Wheel</span>
		                </li>
		                <li class="filter-tope-items">
		                    <span data-filter=".engine">Engine</span>
		                </li>
		                <li class="filter-tope-items">
		                    <span data-filter=".door">Car Door</span>
		                </li>
		                <li class="filter-tope-items">
		                    <span data-filter=".body">Body Car</span>
		                </li>
		                <li class="filter-tope-items">
		                    <span data-filter=".mechanic">Mechanic</span>
		                </li>
		            </ul>
		            <div class="row isotope-grid">
		            	<!-- Product-1 -->
		                <div class="wheel col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 isotope-item">
		                ...
		                <!-- Product-2 -->
		                <div class="engine col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 isotope-item">
		                	<div class="gallery-content">
		                ...
		                <!-- Product-4 -->
		                <div class="mechanic col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 isotope-item">
		                	<div class="gallery-content">
		                ...
		                <!-- Product-7 -->
		                <div class="door col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 isotope-item">
		                	<div class="gallery-content">
		                ...
		                <!-- Product-9 -->
		                <div class="body col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 isotope-item">
		                	<div class="gallery-content">
								<img src="images/gallery-v3-9.jpg" alt="gallery-9">
								<div class="overlay"></div>
								<div class="gallery-text">
									<div class="gallery-text-inner">
										<p>Inventore Veritatis.</p>
										<span>Cusomer, Luxury</span>
									</div>
									<a href="images/gallery-v3-9.jpg" data-fancybox="gallery" class="gallery-elements">
	                            		<i class="la la-search-plus"></i>
	                                </a>
								</div>
							</div>
		                ...
		                <div class="door col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 isotope-item">
		                	<div class="gallery-content">
								<img src="images/gallery-v3-10.jpg" alt="gallery-10">
								<div class="overlay"></div>
								<div class="gallery-text">
									<div class="gallery-text-inner">
										<p>Voluptate Velitesse.</p>
										<span>Beauty, Fashion</span>
									</div>
									<a href="images/gallery-v3-10.jpg" data-fancybox="gallery" class="gallery-elements">
	                            		<i class="la la-search-plus"></i>
	                                </a>
								</div>
							</div>
		                ...
		                <div class="body col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 isotope-item">
		                	<div class="gallery-content">
								<img src="images/gallery-v3-11.jpg" alt="gallery-11">
								<div class="overlay"></div>
								<div class="gallery-text">
									<div class="gallery-text-inner">
									...
									<a href="images/gallery-v3-11.jpg" data-fancybox="gallery" class="gallery-elements">
	                            		<i class="la la-search-plus"></i>
	                                </a>
								</div>
							</div>
		                ...
		                <div class="body col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 isotope-item">
		                	<div class="gallery-content">
								<img src="images/gallery-v3-12.jpg" alt="gallery-12">
								<div class="overlay"></div>
								<div class="gallery-text">
									<div class="gallery-text-inner">
										<p>Deserunt Mollitanim.</p>
										<span>Beauty, Clean</span>
									</div>
									<a href="images/gallery-v3-12.jpg" data-fancybox="gallery" class="gallery-elements">
	                            		<i class="la la-search-plus"></i>
	                                </a>
								</div>
							</div>
		...
		<!-- End Gallery Section Isotope Section-->
